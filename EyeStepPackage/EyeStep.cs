...
namespace EyeStepPackage
{
	...
	{
		// Token: 0x0600013B RID: 315 RVA: 0x0000B928 File Offset: 0x00009B28
		...
		// Token: 0x0600013D RID: 317 RVA: 0x0000B958 File Offset: 0x00009B58
		private static int finalreg(byte x)
		{
			return (int)(x % 64 % 8);
		}

		// Token: 0x0600013E RID: 318 RVA: 0x0000B970 File Offset: 0x00009B70
		private static int longreg(byte x)
		{
			return (int)(x % 64 / 8);
		}

		// Token: 0x0600013F RID: 319 RVA: 0x0000B988 File Offset: 0x00009B88
		...
		// Token: 0x06000140 RID: 320 RVA: 0x000159D0 File Offset: 0x00013BD0
		private static byte to_byte(string str, int offset)
		{
			int num = 0;
			bool flag = str[offset] == '?' && str[offset + 1] == '?';
			byte result;
			if (flag)
			{
				result = 0;
		...
		// Token: 0x06000141 RID: 321 RVA: 0x00015AAC File Offset: 0x00013CAC
		public static string to_str(byte b)
		{
			return b.ToString("X2");
		}

		// Token: 0x06000142 RID: 322 RVA: 0x00015ACC File Offset: 0x00013CCC
		public static EyeStep.inst read(int handle, int address)
		{
			EyeStep.<>c__DisplayClass81_0 CS$<>8__locals1;
			CS$<>8__locals1.p = new EyeStep.inst();
			CS$<>8__locals1.p.address = address;
			int num = 0;
			Imports.ReadProcessMemory(handle, address, CS$<>8__locals1.p.bytes, 16, ref num);
			for (int i = 0; i < EyeStep.OP_TABLE.Length; i++)
			{
				...
				bool flag5 = CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len] == b;
				bool flag6 = false;
				for (int j = 2; j < 11; j += 3)
				{
					bool flag7 = op_INFO.code.Length > j;
					if (!flag7)
					{
						break;
					}
					bool flag8 = op_INFO.code[j] == '+';
					if (flag8)
					{
						bool flag9 = op_INFO.code[j + 1] == 'r';
						if (flag9)
						{
							flag6 = true;
							flag5 = (CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len] >= b && CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len] < b + 8);
							break;
						}
						bool flag10 = op_INFO.code[j + 1] == 'm' && flag5;
						if (flag10)
						{
							string text = "0";
							text += op_INFO.code[j + 2].ToString();
							byte b4 = EyeStep.to_byte(text, 0);
							bool flag11 = b4 >= 0 && b4 < 8;
							if (flag11)
							{
								flag5 = (EyeStep.longreg(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len + 1]) == (int)b4);
							}
							else
							{
								b4 -= 8;
								flag5 = (EyeStep.longreg(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len + 1]) == (int)b4 && CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len + 1] >= 192);
							}
							break;
						}
						bool flag12 = flag5;
						...
						{
							CS$<>8__locals1.p.len++;
							b = EyeStep.to_byte(op_INFO.code, j + 1);
							flag5 = (CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len] == b);
						}
					}
				}
				bool flag13 = flag5;
				if (flag13)
				{
					...
					if (flag14)
					{
						uint flags = CS$<>8__locals1.p.flags;
						uint num2 = flags;
						if (num2 != 1U)
						{
							if (num2 != 2U)
					...
					int num3 = op_INFO.operands.Length;
					switch (num3)
					{
					case 0:
						break;
					...
					EyeStep.<>c__DisplayClass81_1 CS$<>8__locals2;
					CS$<>8__locals2.c = 0;
					while (CS$<>8__locals2.c < num3)
					{
						...
						if (flag15)
						{
							b6 = (byte)EyeStep.longreg(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len]);
						}
						bool flag16 = flag6;
						if (flag16)
						{
							b6 = (byte)EyeStep.finalreg(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len - 1]);
						}
						...
						case OP_TYPES.Sreg:
						{
							...
							p10.data += EyeStep.mnemonics.sreg_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 131072U;
							break;
						}
						case OP_TYPES.ptr16_32:
						{
							EyeStep.<read>g__get_imm32|81_2(BitConverter.ToUInt32(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len), true, ref CS$<>8__locals1, ref CS$<>8__locals2);
							EyeStep.inst p11 = CS$<>8__locals1.p;
							p11.data += ":";
							EyeStep.<read>g__get_imm16|81_1(BitConverter.ToUInt16(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len), true, ref CS$<>8__locals1, ref CS$<>8__locals2);
							break;
						}
						case OP_TYPES.ES:
						{
						...
						case OP_TYPES.r8:
						{
							...
							p18.data += EyeStep.mnemonics.r8_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 1024U;
							break;
						}
						case OP_TYPES.r16:
						{
							...
							p19.data += EyeStep.mnemonics.r16_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 2048U;
							break;
						}
						...
						case OP_TYPES.r32:
						{
							...
							p20.data += EyeStep.mnemonics.r32_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 4096U;
							break;
						}
						case OP_TYPES.r64:
						{
							...
							p21.data += EyeStep.mnemonics.r64_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
						...
						case OP_TYPES.STi:
						{
							bool flag17 = (CS$<>8__locals1.p.flags & 32U) == 32U;
							if (flag17)
							{
							...
							{
								bool flag18 = (CS$<>8__locals1.p.flags & 128U) == 128U;
								if (flag18)
								{
								...
								{
									bool flag19 = (CS$<>8__locals1.p.flags & 256U) == 256U;
									if (flag19)
									{
									...
									{
										bool flag20 = (CS$<>8__locals1.p.flags & 64U) == 64U;
										if (flag20)
										{
										...
										{
											bool flag21 = (CS$<>8__locals1.p.flags & 512U) == 512U;
											if (flag21)
											{
											...
											{
												bool flag22 = (CS$<>8__locals1.p.flags & 1024U) == 1024U;
												if (flag22)
												{
							...
							bool flag23 = CS$<>8__locals1.p.operands[CS$<>8__locals2.c].opmode == OP_TYPES.moffs16_32;
							if (flag23)
							{
								EyeStep.inst p28 = CS$<>8__locals1.p;
								p28.data += "[";
								EyeStep.<read>g__get_imm32|81_2(BitConverter.ToUInt32(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len + 1), true, ref CS$<>8__locals1, ref CS$<>8__locals2);
								EyeStep.inst p29 = CS$<>8__locals1.p;
								p29.data += "]";
							}
							else
							{
								bool flag24 = CS$<>8__locals2.c == 0;
								if (flag24)
								{
									b5 = b6;
								}
								b6 = (byte)EyeStep.finalreg(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len]);
								...
								case 0:
								{
									...
									if (b8 != 4)
									{
										if (b8 != 5)
										{
											...
											p31.data += EyeStep.mnemonics.r32_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
											CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 4096U;
										}
										else
										{
											EyeStep.inst p32 = CS$<>8__locals1.p;
											string data = p32.data;
											uint num4 = CS$<>8__locals1.p.operands[CS$<>8__locals2.c].disp32 = BitConverter.ToUInt32(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len + 1);
											p32.data = data + num4.ToString("X8");
									...
									{
										EyeStep.<read>g__get_sib|81_3(0, ref CS$<>8__locals1, ref CS$<>8__locals2);
									}
								...
								case 1:
								{
									...
									if (flag25)
									{
										EyeStep.<read>g__get_sib|81_3(1, ref CS$<>8__locals1, ref CS$<>8__locals2);
									}
									else
									{
										EyeStep.inst p35 = CS$<>8__locals1.p;
										p35.data += EyeStep.mnemonics.r32_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 4096U;
										EyeStep.<read>g__get_imm8|81_0(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len + 1], false, ref CS$<>8__locals1, ref CS$<>8__locals2);
									}
								...
								case 2:
								{
									...
									if (flag26)
									{
										EyeStep.<read>g__get_sib|81_3(4, ref CS$<>8__locals1, ref CS$<>8__locals2);
									}
									else
									{
										EyeStep.inst p38 = CS$<>8__locals1.p;
										p38.data += EyeStep.mnemonics.r32_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 4096U;
										EyeStep.<read>g__get_imm32|81_2(BitConverter.ToUInt32(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len + 1), false, ref CS$<>8__locals1, ref CS$<>8__locals2);
									}
								...
								case 3:
								{
									...
									OP_TYPES op_TYPES = opmode;
									if (op_TYPES <= OP_TYPES.m16)
									{
										if (op_TYPES <= OP_TYPES.r_m16)
										{
											if (op_TYPES == OP_TYPES.r_m8)
											{
												goto IL_138A;
											}
											if (op_TYPES != OP_TYPES.r_m16)
										...
										p40.data += EyeStep.mnemonics.r16_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 2048U;
										break;
										IL_138A:
										EyeStep.inst p41 = CS$<>8__locals1.p;
										p41.data += EyeStep.mnemonics.r8_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 1024U;
									}
									else if (op_TYPES <= OP_TYPES.ST)
									{
										if (op_TYPES != OP_TYPES.m128)
										{
											switch (op_TYPES)
											{
											case OP_TYPES.mm_m64:
											{
												...
												p42.data += EyeStep.mnemonics.mm_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
											...
											case OP_TYPES.ST:
											{
												...
												p43.data += EyeStep.mnemonics.st_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										...
										p44.data += EyeStep.mnemonics.xmm_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 16384U;
									}
									else if (op_TYPES != OP_TYPES.CRn)
									{
										if (op_TYPES != OP_TYPES.DRn)
										{
											goto IL_1658;
										}
										EyeStep.inst p45 = CS$<>8__locals1.p;
										p45.data += EyeStep.mnemonics.dr_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
										CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 262144U;
									}
									else
									{
										EyeStep.inst p46 = CS$<>8__locals1.p;
										p46.data += EyeStep.mnemonics.cr_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
									...
									p47.data += EyeStep.mnemonics.r32_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
									CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 4096U;
									break;
								}
								}
						...
						case OP_TYPES.rel8:
							EyeStep.<read>g__get_rel8|81_4(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len], ref CS$<>8__locals1, ref CS$<>8__locals2);
							break;
						case OP_TYPES.rel16:
							EyeStep.<read>g__get_rel16|81_5(BitConverter.ToUInt16(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len), ref CS$<>8__locals1, ref CS$<>8__locals2);
							break;
						case OP_TYPES.rel16_32:
						case OP_TYPES.rel32:
							EyeStep.<read>g__get_rel32|81_6(BitConverter.ToUInt32(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len), ref CS$<>8__locals1, ref CS$<>8__locals2);
							break;
						case OP_TYPES.imm8:
							EyeStep.<read>g__get_imm8|81_0(CS$<>8__locals1.p.bytes[CS$<>8__locals1.p.len], true, ref CS$<>8__locals1, ref CS$<>8__locals2);
							break;
						case OP_TYPES.imm16:
							EyeStep.<read>g__get_imm16|81_1(BitConverter.ToUInt16(CS$<>8__locals1.p.bytes, CS$<>8__locals1.p.len), true, ref CS$<>8__locals1, ref CS$<>8__locals2);
							break;
						...
						case OP_TYPES.mm:
						{
							...
							p52.data += EyeStep.mnemonics.mm_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 32768U;
							break;
						}
						case OP_TYPES.xmm:
						{
							...
							p53.data += EyeStep.mnemonics.xmm_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 16384U;
							break;
						}
						case OP_TYPES.xmm0:
						...
						case OP_TYPES.ST:
						{
							...
							p55.data += EyeStep.mnemonics.st_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(0)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 65536U;
							break;
						}
						case OP_TYPES.CRn:
						{
							...
							p56.data += EyeStep.mnemonics.cr_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 524288U;
							break;
						}
						case OP_TYPES.DRn:
						{
							EyeStep.inst p57 = CS$<>8__locals1.p;
							p57.data += EyeStep.mnemonics.dr_names[(int)CS$<>8__locals1.p.operands[CS$<>8__locals2.c].append_reg(b6)];
							CS$<>8__locals1.p.operands[CS$<>8__locals2.c].flags |= 262144U;
							break;
						}
						}
						bool flag27 = CS$<>8__locals2.c < num3 - 1 && num3 > 1;
						if (flag27)
						{
							EyeStep.inst p58 = CS$<>8__locals1.p;
							p58.data += ",";
						}
			...
			bool flag28 = CS$<>8__locals1.p.len == 0;
			if (flag28)
			{
		...
		// Token: 0x06000143 RID: 323 RVA: 0x000177B0 File Offset: 0x000159B0
		public static List<EyeStep.inst> read(int handle, int address, int count)
		{
			int num = address;
			List<EyeStep.inst> list = new List<EyeStep.inst>();
			for (int i = 0; i < count; i++)
			{
				EyeStep.inst inst = EyeStep.read(handle, num);
				list.Add(inst);
				num += inst.len;
			}
			return list;
		...
		// Token: 0x06000144 RID: 324 RVA: 0x000177FC File Offset: 0x000159FC
		public static List<EyeStep.inst> read_range(int handle, int from, int to)
		{
			int i = from;
			List<EyeStep.inst> list = new List<EyeStep.inst>();
			while (i < to)
			{
				EyeStep.inst inst = EyeStep.read(handle, i);
				list.Add(inst);
				i += inst.len;
			}
			return list;
		...
		// Token: 0x06000147 RID: 327 RVA: 0x0001785C File Offset: 0x00015A5C
		[CompilerGenerated]
		internal static void <read>g__get_imm8|81_0(byte x, bool constant, ref EyeStep.<>c__DisplayClass81_0 A_2, ref EyeStep.<>c__DisplayClass81_1 A_3)
		{
			bool flag = !constant;
			string str;
			if (flag)
		...
		// Token: 0x06000148 RID: 328 RVA: 0x000179CC File Offset: 0x00015BCC
		[CompilerGenerated]
		internal static void <read>g__get_imm16|81_1(ushort x, bool constant, ref EyeStep.<>c__DisplayClass81_0 A_2, ref EyeStep.<>c__DisplayClass81_1 A_3)
		{
			bool flag = !constant;
			string str;
			if (flag)
		...
		// Token: 0x06000149 RID: 329 RVA: 0x00017B40 File Offset: 0x00015D40
		[CompilerGenerated]
		internal static void <read>g__get_imm32|81_2(uint x, bool constant, ref EyeStep.<>c__DisplayClass81_0 A_2, ref EyeStep.<>c__DisplayClass81_1 A_3)
		{
			bool flag = !constant;
			string str;
			if (flag)
		...
		// Token: 0x0600014A RID: 330 RVA: 0x00017CB0 File Offset: 0x00015EB0
		[CompilerGenerated]
		internal static void <read>g__get_sib|81_3(byte imm, ref EyeStep.<>c__DisplayClass81_0 A_1, ref EyeStep.<>c__DisplayClass81_1 A_2)
		{
			...
			{
				bool flag2 = b2 == 5 && A_1.p.bytes[A_1.p.len - 1] < 64;
				if (flag2)
				{
			...
			if (flag4)
			{
				EyeStep.<read>g__get_imm8|81_0(A_1.p.bytes[A_1.p.len + 1], false, ref A_1, ref A_2);
			}
			else
			{
				bool flag5 = imm == 4 || (imm == 0 && b2 == 5);
				if (flag5)
				{
					EyeStep.<read>g__get_imm32|81_2(BitConverter.ToUInt32(A_1.p.bytes, A_1.p.len + 1), true, ref A_1, ref A_2);
				}
			}
		}

		// Token: 0x0600014B RID: 331 RVA: 0x00017FB8 File Offset: 0x000161B8
		[CompilerGenerated]
		internal static void <read>g__get_rel8|81_4(byte x, ref EyeStep.<>c__DisplayClass81_0 A_1, ref EyeStep.<>c__DisplayClass81_1 A_2)
		{
		...
		// Token: 0x0600014C RID: 332 RVA: 0x00018050 File Offset: 0x00016250
		[CompilerGenerated]
		internal static void <read>g__get_rel16|81_5(ushort x, ref EyeStep.<>c__DisplayClass81_0 A_1, ref EyeStep.<>c__DisplayClass81_1 A_2)
		{
			int num = A_1.p.address + A_1.p.len;
		...
		// Token: 0x0600014D RID: 333 RVA: 0x000180E8 File Offset: 0x000162E8
		[CompilerGenerated]
		internal static void <read>g__get_rel32|81_6(uint x, ref EyeStep.<>c__DisplayClass81_0 A_1, ref EyeStep.<>c__DisplayClass81_1 A_2)
		{
			int num = A_1.p.address + A_1.p.len;
		...
		{
			// Token: 0x06000150 RID: 336 RVA: 0x0001847F File Offset: 0x0001667F
		...
		{
			// Token: 0x06000151 RID: 337 RVA: 0x000184A0 File Offset: 0x000166A0
			public operand()
			{
			...
			// Token: 0x06000152 RID: 338 RVA: 0x00018514 File Offset: 0x00016714
			~operand()
			{
			}

			// Token: 0x06000153 RID: 339 RVA: 0x00018540 File Offset: 0x00016740
		...
		public class inst
		{
			// Token: 0x06000154 RID: 340 RVA: 0x00018560 File Offset: 0x00016760
			public inst()
			{
			...
			// Token: 0x06000155 RID: 341 RVA: 0x000185E8 File Offset: 0x000167E8
			~inst()
			{
				this.operands.Clear();
			}

			// Token: 0x06000156 RID: 342 RVA: 0x00018620 File Offset: 0x00016820
			public EyeStep.operand src()
			{
				bool flag = this.operands.Count <= 0;
				EyeStep.operand result;
				if (flag)
				{
					result = new EyeStep.operand();
				}
				else
				{
			...
			// Token: 0x06000157 RID: 343 RVA: 0x0001865C File Offset: 0x0001685C
			public EyeStep.operand dest()
			{
				bool flag = this.operands.Count <= 1;
				EyeStep.operand result;
				if (flag)
				{
					result = new EyeStep.operand();
